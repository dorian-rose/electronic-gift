      ...
      >
        {!nameHidden && (
          <>
            <label
              htmlFor="name"
              className="relative top-5 left-12 sm:left-20 bg-white px-2 text-lines text-sm"
            >
              Nombre
            </label>
            <input
        ...
        <label
          htmlFor="email"
          className="relative top-5 top-5 left-12 sm:left-20 bg-white px-2 text-lines text-sm"
        >
          Email
        </label>
        <input
          ...
          className="mt-2 w-10/12 m-auto block border border-1 rounded-3xl px-4 py-2 focus:outline-none focus:border-primary "
        />
        <p className="text-center italic text-burgundy ">
        ...
        {!nameHidden && (
          <>
            ...
            <p className="text-center italic text-burgundy ">{passwordMatch}</p>
          </>
        )}
        <button
          className="mt-8  w-10/12 m-auto block bg-primary text-white shadow-md rounded-3xl px-4 py-2 focus:outline-none focus:border-primary hover:text-secondary hover:bg-tertiary hover:border hover:border-1  hover:border-secondary"
          type="submit"
        >
          Login
        </button>
